...
const AuthenticatedInviteRebatesIndexRoute =
  AuthenticatedInviteRebatesIndexRouteImport.update({
    id: '/invite-rebates/',
    path: '/invite-rebates/',
    getParentRoute: () => AuthenticatedRouteRoute,
  } as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authenticated/invite-rebates/': {
      id: '/_authenticated/invite-rebates/'
      path: '/invite-rebates'
      fullPath: '/invite-rebates/'
      preLoaderRoute: typeof AuthenticatedInviteRebatesIndexRouteImport
      parentRoute: typeof AuthenticatedRouteRoute
    }
    '/_authenticated/keys/': {
