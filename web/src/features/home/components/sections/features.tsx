  ...
  const features = [
    {
      ...
      span: 'md:col-span-2',
      icon: <Zap className='text-foreground/70 size-4' />,
      visual: (
        <div className='mt-4 grid grid-cols-3 gap-2'>
          {['OpenAI', 'Claude', 'Gemini', 'DeepSeek', 'Qwen', 'Llama'].map(
            (name) => (
              <div
                key={name}
                className='border-border/30 bg-muted/20 text-muted-foreground hover:border-ring/40 hover:bg-accent flex items-center justify-center rounded-lg border px-3 py-2 text-xs transition-colors duration-300'
              >
                {name}
              </div>
            )
    ...
    },
    {
      ...
      span: 'md:col-span-1',
      icon: <Globe className='text-foreground/70 size-4' />,
      visual: (
              ...
              <div key={step} className='flex items-center gap-2'>
                <div
                  className={`flex size-6 items-center justify-center rounded-full text-[10px] font-bold ${
                    i === 1
                      ? 'border-ring/40 bg-ring/15 text-foreground border'
      ...
      visual: (
        <div className='mt-4 flex items-center gap-3'>
          ...
          <div className='text-muted-foreground flex items-center gap-1.5 text-xs'>
            <Code className='text-foreground/70 size-3.5' />
