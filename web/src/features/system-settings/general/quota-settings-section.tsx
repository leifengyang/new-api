...
// QuotaForInviter / QuotaForInvitee are deliberately absent: the
// registration-time invite rewards were replaced by the invite rebate
// (see InviteRebateSettingsSection) and the server now rejects a non-zero
// value for them, so offering the inputs here would only mislead.
